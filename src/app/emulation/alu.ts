...
export class ALU
{
  ...
  add(op1: number, op2: number, previousCarry: number = 0, subtract: boolean = false): number
  {
    ...
    this.cpu.statusWord.carry = (!subtract && carry[1] === 1) || (subtract && originalOp1 < -originalOp2);
